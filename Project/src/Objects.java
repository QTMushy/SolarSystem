...
class Spaceship extends Objects {
	private Scene loadShape(String obj_name) {
		ObjectFile f = new ObjectFile(ObjectFile.RESIZE, (float) (60 * Math.PI / 180.0));
		Scene s = null;
		try { // load object's definition file to 's'
	...
	public Spaceship() {
		...
		obj_shape = (Shape3D) objBG.getChild(0); // get and cast the object to 'obj_shape'
		obj_shape.setName("spaceship"); // use the name to identify the object

		
		Appearance sphereAppearance = new Appearance();
		
		
		sphereAppearance.setTexture(texturedApp("img/" + "spaceship2.png"));// default image as MarbleTexture
